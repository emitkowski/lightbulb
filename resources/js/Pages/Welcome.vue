        ...
        <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <div v-if="$page.props.auth?.user" class="mt-6">
                    <div class="rounded-lg bg-white p-2 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800">
                        <p class="px-4 pt-2 text-xs font-medium text-gray-400 uppercase tracking-wide dark:text-zinc-500">Queue + WebSocket</p>
                        <BroadcastPing />
                    </div>
                </div>
